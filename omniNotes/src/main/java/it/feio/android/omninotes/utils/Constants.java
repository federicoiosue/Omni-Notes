...
public interface Constants {
    ...
    String APP_STORAGE_DIRECTORY = TAG;
    String APP_STORAGE_DIRECTORY_ATTACHMENTS = "attachments";
    String APP_STORAGE_DIRECTORY_SB_SYNC = "db_sync";

    String DEV_EMAIL = "federico.iosue@gmail.com";

    // Used for updates retrieval
    String PS_METADATA_FETCHER_URL = "http://www.iosue.it/federico/apps/PSMetadataFetcher/get_app_data.php?url=";
    String PLAY_STORE_URL = "https://play.google.com/store/apps/details?id=";
    static long UPDATE_MIN_FREQUENCY = 24 * 60 * 60 * 1000; // 1 day
    String DRIVE_FOLDER_LAST_BUILD = "http://goo.gl/R10Tr5";
    ...
    boolean LOAD_NOTES_SYNC = true;

    String INTENT_KEY = "note_id";
    String INTENT_NOTE = "note";
    String INTENT_MANAGING_SHARE = "managing_share"; // Used when handling received data
    String INTENT_IMAGE = "image";
