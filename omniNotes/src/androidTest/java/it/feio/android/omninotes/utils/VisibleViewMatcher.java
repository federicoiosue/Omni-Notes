 ...
 *
 * Specifically, it matches with views that have "Visible" visibility and positive height and width. A typical example
 * is when a long form has a visible view at the bottom, but the UI needs to be scrolled to reach it.
 */
